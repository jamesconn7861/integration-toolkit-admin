<script lang="ts">
  ...
  export default defineComponent({
    props: {
      vlan: {
        type: Object as PropType<VlanRecord>,
        required: true,
      },
    },
    setup(props) {
      ...
      const currentVlan = reactive({ ...props.vlan });
      return { cardContainer, expandToggle, currentVlan };
    },
    methods: {
      expandCard() {
      ...
      updateCardFields() {
        this.$emit('updateVlan', { ...this.currentVlan }, this.vlan?.id);
      },
      deleteVlan() {
        this.$emit('deleteVlan', this.currentVlan.id, this.currentVlan.name);
      },
    },
  });
</script>
  ...
  <div class="card-container">
    <div class="card blue" ref="cardContainer">
      <div class="card-title">
        <span class="card-id-text">{{ currentVlan.id }}</span>
        <span class="card-title-text">{{ currentVlan.name }}</span>
        <i
          ref="expandToggle"
      ...
      <div class="card-expand">
        ...
        <div class="card-field vis-field">
          ...
          <select class="card-input vis-input" v-model="currentVlan.visibility">
            <option value="Visible">Visible</option>
            <option value="Hidden">Hidden</option>
            <option value="Admin">Admin Only</option>
          </select>
        </div>
        <div class="card-field note-field" :title="currentVlan.notes">
          <span class="input-description">Notes: </span>
          <input class="card-input note-input" v-model="currentVlan.notes" />
        </div>
